...
struct ContentView: View {
                ...
                ScrollView {
                    VStack(spacing: 25) {
                        ...
                        VStack(spacing: 15) {
                            ...
                            // Note Input Field (only shown when can mark today)
                            if canMarkToday {
                                TextField("Add a note for today (optional)", text: $newNote)
    ...
    private var dailyQuote: String {
        let quotes = [
            "Doing nothing is an art, and you're mastering it! 🎨",
            "Sometimes the best thing to do is nothing at all ✨",
            "Empty time is not empty life - it's pure freedom 🦋",
            "Today's achievement: Simply being 🌟",
